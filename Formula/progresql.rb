class Progresql < Formula
  ...
  url "https://github.com/TwilightCoders/progresql/archive/refs/tags/v18.3-0.2.9.tar.gz"
  sha256 "ca472709f273b7d6dc8def7266181aa60bb4cd45db60dcedf93b6a2b1e3e3e5c"
  license "PostgreSQL"
